    ...
    <section className="text-white py-20 px-4 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-zinc-800 rounded-lg p-6 text-center">
          ...
          <p className="text-zinc-400 mb-4">For individuals exploring CodeKrew</p>
        ...
        <div className="bg-zinc-800 rounded-lg p-6 text-center border border-orange-500">
          <h2 className="text-2xl font-semibold mb-2">Pro</h2>
          <p className="text-zinc-400 mb-4">For solo builders and small teams</p>
        ...
        <div className="bg-zinc-800 rounded-lg p-6 text-center">
          ...
          <p className="text-zinc-400 mb-4">Best for growing product teams</p>
